...
public interface IAdminService {
	...
	public Admin validateAdmin(String username, String password, String role)
			throws NullPointerException, NumberFormatException, InputMismatchException, AdminNotFoundException;
}
